                          ...
                          RichText(
                              text: TextSpan(
                                  children: [
                                    ...
                                    TextSpan(text: food, style: TextStyle(color: Theme.of(context).primaryTextTheme.bodyText1!.color, fontWeight: (shoppingListEntry.food != null && shoppingListEntry.food!.recipe != null) ? FontWeight.bold : FontWeight.w400)),
                                  ],
                                  style: (checkBoxValue)
